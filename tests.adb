...
begin
   ...
   -- Just an extra bounds check for 4.3 to fulfill the 3-assertion rule
   ...
   begin
      Check ("8.1 12.5 -> 12 degrees 30 mins", A1.Sign = Positive and A1.Degrees = 12 and A1.Minutes = 30);
      Check ("8.2 0.0 -> 0 degrees", A2.Sign = Positive and A2.Degrees = 0);
   ...
   begin
      Check ("9.1 -12.5 -> Negative sign, 12 degrees", A1.Sign = Negative and A1.Degrees = 12 and A1.Minutes = 30);
      Check ("9.2 -0.25 -> Negative sign, 0 degrees, 15 min", A2.Sign = Negative and A2.Degrees = 0 and A2.Minutes = 15);
      Check ("9.3 -45.0 -> Negative sign, 45 degrees, 0 sec", A3.Sign = Negative and A3.Degrees = 45 and Close_Enough (A3.Seconds, 0.0));
   end;
